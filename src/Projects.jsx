  ...
  return (
    ...
    <div className='projects'>
      <div className='projectinfo'>
        <h5 className='flip' onClick={() => displayDescription('description1')}>The Book App</h5>
        <div id='description1'>
      ...
      <div className='projectinfo'>
        <h5 className='flip' onClick={() => displayDescription('description2')}>The Cocktail App</h5>
        <div id='description2'>
          <p className='p4'>The Cocktail Application allows the user to browse through a selection of mixed drinks as well as their recipes.</p>
      ...
      <div className='projectinfo'>
        <h5 className='flip' onClick={() => displayDescription('description3')}>National Park Trip Planner</h5>
        <div id='description3'>
      ...
      <div className='projectinfo'>
        <h5 className='flip' onClick={() => displayDescription('description4')}>Memory Game</h5>
        <div id='description4'>
